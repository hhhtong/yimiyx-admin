...
<template>
  ...
  <Layout class="table-con">
    <Header style="background: white">
      ...
      <Select v-model="listQuery.couponType" @on-change="handleQuery" style="width:100px">
      ...
      <Button @click="handleEdit(false)" type="success" icon="plus-circled" class="margin-left-20">创建优惠券</Button>
...
import couponTypeList from './components/CouponType'
...
export default {
  ...
  data () {
    return {
      total: 0,
      couponTypeList: [{ value: 0, label: '全部' }, ...couponTypeList],
      listLoading: true,
      listQuery: {
        page: 1,
        rows: 20,
        couponMoney1: 0, // 优惠券面额 起
        couponMoney2: 500, // 优惠券面额 止

...
export const getParams = url => {
  let keyValueArr = url.split('?')[1]
  let paramObj = {}
  if (!keyValueArr) return paramObj
  keyValueArr = keyValueArr.split('&')
 ...
 */
export const parseSearchField = ({ query, field, ID = `${field}ID`, name = `${field}Name` }) => {
  let tempID = 0
  let tempName = ''
